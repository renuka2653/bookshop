...
public class ConfirmRegisterMobileNoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bcnVerify =findViewById(R.id.acbtConfirmRegisterMobileVerify);

        bcnVerify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(etConfirmRegisterMobileNO.getText().toString().isEmpty())
                {
                    etConfirmRegisterMobileNO.setError("Please Enter obile NO");
                ...
                else
                {
                    PhoneAuthProvider.getInstance().verifyPhoneNumber("+91"
                                    +etConfirmRegisterMobileNO.getText().toString(),
                            60, TimeUnit.SECONDS,
                            ...
                            new PhoneAuthProvider.OnVerificationStateChangedCallbacks()
                            {
                                ...
                                public void onVerificationCompleted(@NonNull PhoneAuthCredential phoneAuthCredential) {
                                    ...
                                    Toast.makeText(ConfirmRegisterMobileNoActivity.this,"Verification Success",
                                ...
                                public void onVerificationFailed(@NonNull FirebaseException e) {
                                    progressDialog.dismiss();
                                    Toast.makeText(ConfirmRegisterMobileNoActivity.this, "Verification Failed",
                                            Toast.LENGTH_SHORT).show();
                                }
                                ...
                                {
                                    Intent intent=new Intent(ConfirmRegisterMobileNoActivity.this, ForgetPasswordOTPActivity.class);
